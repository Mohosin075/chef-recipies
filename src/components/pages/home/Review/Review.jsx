...
import MultiProgressBar from "../../../../utility/MultiProgressBar";

const Review = () => {
  return (
    <div className="px-2 lg:px-20 bg-gray-200 py-12 font-semibold text-gray-700">
      <h2 className="text-3xl md:text-5xl text-center font-bold">Review</h2>
      <div className="flex mt-10 justify-around items-center flex-wrap">
        ...
        <div className="bg-white font-bold p-6 rounded mt-5 md:mt-0">
